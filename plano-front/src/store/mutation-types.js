...
//pedidoSIGA.js
export const PEDIDO_SIGA_FETCHED = "PEDIDO_SIGA_FETCHED";
export const SOCKET_PEDIDO_SIGA_UPDATED = "SOCKET_PEDIDO_SIGA_UPDATED";
export const SOCKET_PEDIDO_SIGA_CREATED = "SOCKET_PEDIDO_SIGA_CREATED";
export const SOCKET_PEDIDO_SIGA_DELETED = "SOCKET_PEDIDO_SIGA_DELETED";
...
//gradeCursoExterno.js
export const GRADE_CURSO_EXTERNO_FETCHED = "GRADE_CURSO_EXTERNO_FETCHED";
export const SOCKET_GRADE_CURSO_EXTERNO_UPDATED = "SOCKET_GRADE_CURSO_EXTERNO_UPDATED";
export const SOCKET_GRADE_CURSO_EXTERNO_CREATED = "SOCKET_GRADE_CURSO_EXTERNO_CREATED";
export const SOCKET_GRADE_CURSO_EXTERNO_DELETED = "SOCKET_GRADE_CURSO_EXTERNO_DELETED";

//disciplinaGradeCursoExterno.js
export const DISCIPLINA_GRADE_CURSO_EXTERNO_FETCHED = "DISCIPLINA_GRADE_CURSO_EXTERNO_FETCHED";
export const SOCKET_DISCIPLINA_GRADE_CURSO_EXTERNO_UPDATED =
  "SOCKET_DISCIPLINA_GRADE_CURSO_EXTERNO_UPDATED";
export const SOCKET_DISCIPLINA_GRADE_CURSO_EXTERNO_CREATED =
  "SOCKET_DISCIPLINA_GRADE_CURSO_EXTERNO_CREATED";
export const SOCKET_DISCIPLINA_GRADE_CURSO_EXTERNO_DELETED =
...
//conceitoTurmaCurso.js
export const CONCEITO_TURMA_CURSO_FETCHED = "CONCEITO_TURMA_CURSO_FETCHED";
export const SOCKET_CONCEITO_TURMA_CURSO_UPDATED = "SOCKET_CONCEITO_TURMA_CURSO_UPDATED";
export const SOCKET_CONCEITO_TURMA_CURSO_CREATED = "SOCKET_CONCEITO_TURMA_CURSO_CREATED";
export const SOCKET_CONCEITO_TURMA_CURSO_DELETED = "SOCKET_CONCEITO_TURMA_CURSO_DELETED";
...
export const INCREMENT_PROGRESS_BAR_CURRENT_VALUE = "INCREMENT_PROGRESS_BAR_CURRENT_VALUE";
