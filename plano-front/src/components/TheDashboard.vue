    ...
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          ...
          <p class="nav-link" v-on:click="showModalNovoPlano" v-if="Admin"><i class="fas fa-plus-square"></i> Novo </p>
          <p class="nav-link" v-on:click="showModalLoad" v-if="Admin"><i class="fas fa-folder-open"></i> Carregar</p>
          <p class="nav-link" v-on:click="showModalSave" v-if="Admin"><i class="fas fa-file"></i> Salvar</p>
          <p class="nav-link" v-on:click="showModalDownload" v-if="Admin"><i class="fas fa-save"></i> Download</p>
