    ...
    <div class="div-table col p-0">
      <table class="tg" v-if="horarioVazio(Eletivas)">
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 1)"
            >
              <template
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 7)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 13)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 19)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 25)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 2)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 8)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 14)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 20)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 26)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 3)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 9)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 15)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 21)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 27)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 4)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 10)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 16)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 22)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 28)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 32)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 34)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 36)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 38)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 40)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 33)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 35)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 37)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 39)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 41)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 5)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 11)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 17)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 23)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 29)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 6)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 12)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 18)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 24)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
          ...
          <td class="tg-0lax">
            <template
              v-for="turma in Eletivas"
              v-if="checkTurmaHorario(turma, 30)"
            >
              <template
                v-for="disciplina in Disciplinas"
                v-if="turma.Disciplina === disciplina.id"
