    ...
    <div class="col">
      ...
      <table class="table table-hover table-sm">
        ...
        <template v-if="Pedidos.length > 0">
          <tr v-for="pedido in Pedidos" :key="pedido.id" v-on:click.prevent="showPedidos(pedido)">
        ...
        <template v-else>
          <tr>
            <td colspan="2" class="text-center"><i class="fas fa-exclamation-triangle"></i> Nenhum pedido encontrado!
            </td>
          </tr>
        </template>
        </tbody>
    ...
    <div class="col">
      ...
      <form>
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="departamento" v-model="pedidoForm.departamento">
          </div>
        </div>
        <div class="form-group row">
          <label for="responsavel" class="col-sm-12 col-form-label">Responsável</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="responsavel" v-model="pedidoForm.responsavel">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          <label for="vagasPeriodizadasSolicitadas" class="col-sm-12 col-form-label">Vagas Periodizadas Solicitadas</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="vagasPeriodizadasSolicitadas" v-model="pedidoForm.vagasPeriodizadasSolicitadas">
          </div>
        </div>
        <div class="form-group row">
          <label for="vagasNaoPeriodizadasSolicitadas" class="col-sm-12 col-form-label">Vagas Não Periodizadas Solicitadas</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="vagasNaoPeriodizadasSolicitadas" v-model="pedidoForm.vagasNaoPeriodizadasSolicitadas">
          </div>
        </div>
        <div class="form-group row">
          <label for="vagasPeriodizadasAtendidas" class="col-sm-12 col-form-label">Vagas Periodizadas Atendidas</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="vagasPeriodizadasAtendidas" v-model="pedidoForm.vagasPeriodizadasAtendidas">
          </div>
        </div>
        <div class="form-group row">
          <label for="vagasNaoPeriodizadasAtendidas" class="col-sm-12 col-form-label">Vagas Não Periodizadas Atendidas</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="vagasNaoPeriodizadasAtendidas" v-model="pedidoForm.vagasNaoPeriodizadasAtendidas">
          </div>
        </div>
        <div class="form-group row">
          <label for="disciplina" class="col-sm-12 col-form-label">Disciplina</label>
          <div class="col-sm-10">
            <select type="text" class="form-control" id="disciplina" v-model="pedidoForm.Disciplina">
        ...
        <div class="form-group row">
          <div class="col-sm-10">
            <template v-if="isEdit">
              <button type="button" class="btn btn-success m-2" v-on:click.prevent="editPedido" :key="1">Editar</button>
              <button type="button" class="btn btn-danger m-2" v-on:click.prevent="deletePedido" :key="3">Excluir
              </button>
              <button type="button" class="btn btn-secondary m-2" v-on:click.prevent="cleanPedido" :key="2">Cancelar
              </button>
            </template>
            <template v-else>
              <button type="button" class="btn btn-success m-2" v-on:click.prevent="addPedido" :key="1">Adicionar
              </button>
              <button type="button" class="btn btn-secondary m-2" v-on:click.prevent="cleanPedido" :key="2">Resetar
              </button>
            </template>
          </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            editPedido() {
                pedidoService.update(this.pedidoForm.id, this.pedidoForm).then((response) => {
                    this.$notify({
                        group: 'general',
                        title: `Sucesso!`,
