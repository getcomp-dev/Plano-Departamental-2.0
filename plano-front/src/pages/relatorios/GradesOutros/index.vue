...
<script>
    ...
    export default {
                    ...
                    this.CursosComGrades.forEach((curso) => {
                        ...
                        if (gradedisciplina !== undefined) {
                            if (
                                ...
                                this.disciplinasGrades[parseInt(d, 10)][curso.id][0].push(
                    ...
                    this.CursosComGrades.forEach((curso) => {
                        ...
                        if (gradedisciplina !== undefined) {
                            if (
                                ...
                                //tem entrada de alunos no 1º semestre ou no 3º semestre -> terá períodos ímpares no primeiro semestre
                                this.disciplinasGrades[parseInt(d, 10)][curso.id][1].push(
                                    gradedisciplina.periodo
                                );
                            if (
                                (curso.semestreInicial === 2 || curso.semestreInicial === 3) &&
        ...
        computed: {
            ...mapGetters(["PrincipaisCursosDCC", "DisciplinasInPerfis", "AllPerfis", "AllCursos", "AllGradesCursosExternos"]),
