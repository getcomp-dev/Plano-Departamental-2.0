...
const history = function(params){
    models.History.create({
        tabelaModificada: 'DisciplinaGradeCursoExterno',
...
router.post('/', function (req, res, next) {
    ...
    models.DisciplinaGradeCursoExterno.create({
        periodo: req.body.periodo,
        Disciplina: req.body.Disciplina,
        Grade: req.body.Grade
    }).then(function (disciplinaGrade) {
        ioBroadcast(SM.DISCIPLINA_GRADE_CURSO_EXTERNO_CREATED, {'msg': 'Disciplina adicionada à Grade!', 'DisciplinaGrade': disciplinaGrade})
        console.log('\nRequest de '+req.usuario.nome+'\n')
...
router.get('/', function (req, res, next) {
    models.DisciplinaGradeCursoExterno.findAll().then(function (disciplinaGrades) {
        res.send({
            success: true,
...
router.post('/:Disciplina([0-9]+)&&:Grade([0-9]+)', function (req, res, next) {
    console.log('\nRequest de '+req.usuario.nome+'\n')
    models.DisciplinaGradeCursoExterno.findOne({
        where: {
        ...
        ioBroadcast(SM.DISCIPLINA_GRADE_CURSO_EXTERNO_UPDATED, {'msg': 'Disciplina da grade atualizada!', 'DisciplinaGrade': disciplinaGrade})
        console.log('\nRequest de '+req.usuario.nome+'\n')
...
router.delete('/:Disciplina([0-9]+)&&:Grade([0-9]+)', function (req, res, next) {
    ...
    models.DisciplinaGradeCursoExterno.findOne({
        ...
        ioBroadcast(SM.DISCIPLINA_GRADE_CURSO_EXTERNO_DELETED, {'msg': 'Disciplina excluída da grade!', 'DisciplinaGrade': disciplinaGrade})
        console.log('\nRequest de '+req.usuario.nome+'\n')
